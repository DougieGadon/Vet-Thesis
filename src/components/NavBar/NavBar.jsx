  ...
  return (
    <div
      ...
      className={`z-20 h-[75px] w-screen px-0 lg:h-[90px] lg:px-12 ${
        ...
        bg === "#adc6af" ? "bg-bgGreen" : "bg-bgGreen"
      }`}
    >
      <div className="flex h-full items-center justify-between px-4 lg:px-0">
        ...
        <div className="align-center flex h-5 w-auto justify-center">
        {role === "admin" ? (
            ...
            <div className="profile z-10">
                <NavLink className="scale-y-110 flex-col items-start text-[22px] font-bold leading-[20px] text-secGreen md:my-16 md:ml-7 md:leading-[20px] lg:text-[20px]" to="/">HOME</NavLink>
                <NavLink className="scale-y-110 flex-col items-start text-[22px] font-bold leading-[20px] text-secGreen md:my-16 md:ml-7 md:leading-[20px] lg:text-[20px]" to="/services">SERVICES</NavLink>
                <NavLink className="scale-y-110 flex-col items-start text-[22px] font-bold leading-[20px] text-secGreen md:my-16 md:ml-7 md:leading-[20px] lg:text-[20px]" to="/doctors">DOCTORS</NavLink>
