          ...
          <div className="-m-3 flex flex-wrap">
            <div className="w-full p-3 md:w-1/3">
              <div className="border-blueGray-100 shadow-11xl h-full rounded-xl border bg-bgGreen bg-opacity-90 p-11 text-center shadow-md">
                ...
                <h4 className="font-heading mb-3 text-l font-bold leading-snug">
                  San Francisco Branch
                  </h4>
                <p className="font-medium leading-relaxed">Monday to Saturday: 8AM to 6PM <br />Sunday: 8AM to 5PM
                </p>
                <h4 className="font-heading mb-3 text-l font-bold leading-snug">
                  Manggahan Branch
                  </h4>
            ...
            <div className="w-full p-3 md:w-1/3">
              <div className="border-blueGray-100 shadow-11xl h-full rounded-xl border bg-bgGreen bg-opacity-90 p-11 text-center shadow-md">
                ...
                <p className="mx-auto max-w-xs font-medium leading-relaxed">
                  KK Building, Phase 3, Block 11A, Lot 7, Brookside Lane, Brgy. San Francisco, General Trias, Cavite
                </p>
                <h4 className="font-heading mb-3 text-l font-bold leading-snug">
                  Manggahan Branch
                  </h4>
                  <p className="mx-auto max-w-xs font-medium leading-relaxed">
                  A&C Building, Block 8, Lot 20, Sunshine Village, Brgy. Manggahan, General Trias, Cavite
                </p>
              </div>
            </div>
          </div>
