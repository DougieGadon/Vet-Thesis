...
const Hero = () => {
  ...
  return (
    <div className="relative -mt-12 flex h-[70vh] w-full flex-col items-center justify-end overflow-hidden px-4 pb-12 md:-mt-16 lg:-mt-20 lg:pb-5">
      ...
      <div className="z-10 w-full max-w-[1280px] lg:flex lg:items-start lg:justify-between lg:gap-20">
        ...
        <div className="lg:flex lg:flex-col lg:items-end lg:pb-4">
          <h2 className="mt-4 text-[16px] text-secGreen">
